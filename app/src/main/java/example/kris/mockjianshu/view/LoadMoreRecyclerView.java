...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    public final static int TYPE_GRID = 5;//代码item展示模式是网格模式
...
//        super.swapAdapter(mAutoLoadAdapter, true);
    ...
    private int getLastVisiblePosition() {
        ...
        if (getLayoutManager() instanceof LinearLayoutManager) {
            ...
            final GridLayoutManager glm = (GridLayoutManager) getLayoutManager();
            position = glm.findLastVisibleItemPosition();
//            glm.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
//                @Override
//                public int getSpanSize(int position) {
//                    Log.d("getLastVisiblePosition", "span size position:" + position);
